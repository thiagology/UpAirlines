...
public enum Cidades {
    ...
    CURITIBA(7, "Curitiba"), FLORIANOPOLIS(8, "Florian�polis"), FORTALEZA(9, "Fortaleza"), GOIANIA(10, "Goiânia"),
    JOAO_PESSOA(11, "Jo�o Pessoa"), MACAPA(12, "Macap�"), MACEIO(13, "Maceió"), MANAUS(14, "Manaus"),
